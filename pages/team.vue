...
<a href="https://HarrisonKugler.com" target="_blank">
  <button
    class="z-20 block p-4 text-blue-500 transition-all bg-blue-100 border-2 border-white rounded-full active:bg-blue-50 hover:scale-110 focus:outline-none focus:ring"
    type="button"
  >
...
<a href="https://www.linkedin.com/in/hkugler/" target="_blank">
  <button
    class="z-30 block p-4 text-blue-500 transition-all bg-blue-100 border-2 border-white rounded-full hover:scale-110 focus:outline-none focus:ring active:bg-red-50"
    type="button"
  >
   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
  </button>
</a>
<a href="mailto:harrison@freshsaltagency.com" target="_blank">
  <button
    class="z-30 block p-4 text-blue-500 transition-all bg-blue-100 border-2 border-white rounded-full hover:scale-110 focus:outline-none focus:ring active:bg-red-50"
    type="button"
  >
					...
					<div class="lg:col-start-2">
						...
						<div class="flex">
							...
							<div class="flex items-center justify-center ml-4">
								<h4 class="text-lg font-medium  leading-6 text-gray-900">Pakistan</h4>
							</div>
						</div>
						<div class="flex">
							<div class="flex-shrink-0">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
					...
					<div class="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
						<img src="~/assets/usama2.jpg" alt="" class="mx-auto rounded-lg shadow-lg bg-gray-500">
					</div>
				</div>
			</div>
