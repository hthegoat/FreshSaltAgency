  ...
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    ...
    <section class="flex flex-col items-center">
      <div class="max-w-xl flex flex-col items-center text-center pt-8 lg:pt-32 pb-16 lg:pb-48">
        <p class="text-accent md:text-lg xl:text-xl font-semibold mb-4 md:mb-6">Fresh Salt Agency</p>

        <h1 class="text-secondary text-4xl sm:text-5xl md:text-6xl font-bold mb-8 md:mb-12">Google Ads Done Right</h1>
    ...
    <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        <div class="h-64 md:h-auto bg-gray-100 overflow-hidden rounded-lg shadow-lg">
          <img src="~/assets/google1.jpg" loading="lazy" alt="Photo by Martin Sanchez" class="w-full h-full object-cover object-center" />
        </div>
      </div>

      <div class="md:pt-4">
        <p class="text-indigo-500 font-bold text-center md:text-left">Why Google Ads</p>
        ...
        <p class="text-gray-500 sm:text-lg mb-6 md:mb-8">
          In a nutshell, our job is to get you more clicks and conversions while lowering your click costs. We’ve got years of experience working with big-name companies, so we understand how complicated Google AdWords can be and we’re here to help you reach your goals. Whether you’re looking to increase traffic, achieve conversions, or simply reach more target customers, we are here for you.
        </p>
