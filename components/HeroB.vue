<template>
	...
	<section class="mb-10 text-gray-800">
		<div class="bg-slate-100 container mx-auto max-w-2xl flex flex-col p-6">
			<h2 class="py-4 text-3xl font-bold text-center">How This Works</h2>
			<div class="divide-y divide-gray-300">
				<div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
					...
					<div class="flex flex-col justify-center max-w-xl text-center col-span-full lg:col-span-3 lg:text-center">
						<span class="text-m tracking-wider uppercase text-blue-500">Step 1</span>
						<span class="text-xl font-bold md:text-2xl">Consultation</span>
						<span class="mt-4 text-gray-700">Let's discuss what you have done, your goals, and how we can possibly be of service.</span>
					</div>
				</div>
				<div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
					<div class="flex items-center justify-center lg:col-span-1 col-span-full">
					...
					<div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-center">
						<span class="text-xs tracking-wider uppercase text-violet-600">Step 2 - Proposal</span>
						<span class="text-xl font-bold md:text-2xl">Audit & Proposal </span>
						<span class="mt-4 text-gray-700">We’ll perform an in-depth review of your PPC strategy and put our findings into a proposal complete with actionable insights.
				...
				<div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
					...
					<div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-center">
						...
						<span class="text-xl font-bold md:text-2xl">Let's Crush Some Goals</span>
						<span class="mt-4 bg-gray-100 text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim cons equatur nihil ipsum.</span>
					</div>
				</div>
