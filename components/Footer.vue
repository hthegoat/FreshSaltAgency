  ...
  <div class="  max-w-screen-xl justify-center px-4 py-16 mx-auto space-y-12 sm:px-6 lg:px-8">
    <div class="flex flex-col sm:items-center object-center items-center sm:justify-between sm:flex">
      ...
      <div class="flex mt-8 space-x-6 text-gray-500 sm:mt-0">
        <a class="hover:opacity-75" href="https://facebook.com/freshsaltagency" target="_blank" rel="noreferrer">
        ...
        <a class="hover:opacity-75" href="https://www.instagram.com/freshsaltagency/" target="_blank" rel="noreferrer">
        ...
        <a class="hover:opacity-75" href="https://twitter.com/FreshSaltAgency" target="_blank" rel="noreferrer">
