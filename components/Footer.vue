    ...
    <div class="grid grid-cols-1 text-center gap-8 pt-12 border-t border-gray-100 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        ...
        <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
          ...
          <NuxtLink class="hover:opacity-75" to="/bth"> Case Study #1 </NuxtLink>
          <NuxtLink class="hover:opacity-75" to="projects/pineridge"> Case Study #2 </NuxtLink>
          <NuxtLink class="hover:opacity-75" to="/keystone"> Case Study #3 </NuxtLink>
        </nav>
      </div>
