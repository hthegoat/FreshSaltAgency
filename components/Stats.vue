<template>
  ...
  <div class="max-w-screen-xl justify-center items-center px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div class="max-w-full">
      <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-12 md:mb-12">Numbers Don't Lie</h2>
