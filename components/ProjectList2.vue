...
>
  <img
    ...
    src="~/assets/uhoh1.png"
    class="object-cover w-full h-64 object-top rounded-md"
  />

  <div class="mt-2">
    <dl>
      <div class="sm:inline-flex sm:items-center sm:shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" class="hover:animate-bounce h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
</svg>

        <dd class="text-2xl ml-4 font-black text-secondary">
          $10,315
        </dd>
      </div>
...
>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
      ...
      <div>
        ...
        <dd class="font-medium">
         Micro Dojo: Loyalty & Deceit (Expansion Pack)
        </dd>
      </div>
    </dl>
