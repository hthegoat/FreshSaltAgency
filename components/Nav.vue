    ...
    <div class="flex items-center justify-between">
      ...
      >
        <div @keydown.esc="isOpen = false" v-show="isOpen" class="z-10 fixed inset-0 transition-opacity">
            <div @click="isOpen = false" class="absolute inset-0" tabindex="0"></div>
        </div>
      </transition>

      <!-- Drawer Menu -->
      <aside class="p-5 transform top-0 left-0 w-64 bg-gray-300 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <div class="follow">
          ...
          <div class="social flex space-x-5 mt-4 ">
            <a href="https://twitter.com/FreshSaltAgency"
            target="_blank">
              <svg
            ...
            <a href="https://www.facebook.com/freshsaltagency" target="_blank">
              <svg
                aria-hidden="true" focusable="false"
